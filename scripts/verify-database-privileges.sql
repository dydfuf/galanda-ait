...
BEGIN
	FOREACH public_role IN ARRAY ARRAY['anon', 'authenticated', 'service_role']::name[] LOOP
		FOREACH app_table IN ARRAY ARRAY['user', 'session', 'account', 'verification', 'participant', 'participant_alias', 'trip_rooms', 'trip_invite', 'confirmed_itineraries', 'itinerary_revisions', 'itinerary_acknowledgements', 'explore_plan_listings', 'explore_plan_saves', 'explore_listing_cities', 'trip_resources']::name[] LOOP
